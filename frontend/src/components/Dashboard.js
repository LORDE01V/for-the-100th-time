...
// Add PropTypes validation for ChakraIcon
ChakraIcon.propTypes = {
  icon: PropTypes.elementType.isRequired,  // Validates that 'icon' is a valid React component
};
