...
function ImpactPage() {
  ...
  const fetchBackendStories = async () => {
    try {
      const response = await axios.get('https://backend-7oa8.onrender.com/api/community-stories');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://backend-7oa8.onrender.com/api/community-stories', {
        user_name: name,
        story_text: quote,
        rating: rating,
      });
